...
<body>
  ...
  <div class="content">
    ...
    <!-- Untuk line-chart -->
    <div class="dashboard">
      <h1><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bar-chart-line-fill" viewBox="0 0 16 16">
          <path d="M11 2a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v12h.5a.5.5 0 0 1 0 1H.5a.5.5 0 0 1 0-1H1v-3a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v3h1V7a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v7h1z" />
        </svg> Grafik</h1>
      <p><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-info-circle-fill" viewBox="0 0 16 16">
        ...
        </svg> Halaman ini memuat Grafik Penjualan dan Inventaris.</p>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      const fileUrl = "<?= base_url('data/final.xlsx'); ?>";
